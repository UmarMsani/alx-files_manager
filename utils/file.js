...
const fileUtils = {
  ...
  /**
   * Transform _id into id in a file documents.
   *
   * @doc {object} document to be processed.
   * @return {object} processed document.
   */
  processFile(doc) {
    // Changes the _id for id and removes localPath.
  ...
  /**
   * Checks if file is public and belongs to a
   * specific user.
   *
   * @file {object} file to evaluate.
   * @userId {string} id of user to check the ownership.
   ...
   * @return {object} data of file or error and the status code.
   */
